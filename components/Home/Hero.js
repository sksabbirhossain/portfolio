      ...
      <div className="z-10 items-center px-2 text-center">
        <div className="flex flex-col items-center gap-4">
          <Image
            ...
            height={150}
            alt="me image"
            className="h-24 w-24 rounded-full object-cover ring-2 ring-gray-200 sm:h-26 sm:w-26"
          />
          <p className="font-ovo text-xl text-gray-600 capitalize sm:text-2xl">
            Hi! I’m Md Sabbir Hossain 👋🏻
          </p>
        </div>
        <div className="mt-3 flex flex-col items-center justify-center text-center">
          <h1 className="font-ovo w-full max-w-4xl text-3xl text-gray-900 capitalize md:text-5xl lg:text-7xl">
            full stack web developer from Bangladesh.
          </h1>
          <p className="mt-4 w-full max-w-2xl text-gray-700">
